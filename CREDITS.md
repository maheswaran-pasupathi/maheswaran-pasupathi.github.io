...
2. Reference it:
   - **In an article:** front matter `cover: /images/<file>` (+ `coverAlt`,
     `coverCredit`, `coverCreditUrl`), or `![alt](/images/<file>)` in the body
   - **Homepage hero / exploration tiles:** edit `src/data/siteImages.ts`
3. Add a row to the table below

## In use

| File | Where | Source | Photographer / owner | Licence / usage |
|------|-------|--------|----------------------|-----------------|
...
| Remote official promotional artwork | *Hidden Figures — a movie that stayed with me* | [20th Century Studios — Hidden Figures](https://family.20thcenturystudios.com/movies/hidden-figures) | © 20th Century Studios | Official promotional artwork displayed in context of personal film commentary; all rights remain with copyright owner |
